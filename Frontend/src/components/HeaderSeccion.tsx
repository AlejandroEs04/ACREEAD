    ...
    <div ref={ref} className="relative isolate overflow-hidden bg-gray-900 py-8 sm:py-24">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
                <h2 className="text-4xl font-normal tracking-tight text-white sm:text-6xl">Welcome to <span className="font-bold text-sky-500"><img src="./public/logoWhite.svg" alt="acreead logo" className="w-96" /></span></h2>

                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="flex space-x-4">
                            <Link to="#" className="rounded-md transition-colors bg-zinc-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Main</Link>
                            <Link to="#" className="rounded-md transition-colors px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Services</Link>
                            <Link to="#" className="rounded-md transition-colors px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Portfolio</Link>
                            <Link to="#" className="rounded-md transition-colors px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About Us</Link>
                            <Link to="#" className="rounded-md transition-colors px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact Us</Link>
                        </div>
                        </div>
                    </div>
